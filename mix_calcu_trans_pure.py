...
element = 'Cd'
density_sample = pt.elements.isotope(element).density  # g/cm3  https://en.wikipedia.org/wiki/Cadmium
...
_energy_x_axis = 1  # 1 means plot x-axis as energy in eV
_trans_y_axis = 0  # 1 means plot y-axis as transmission
_plot_each_contribution = 0  # 1 means plot y-axis as lamda in Angstrom
# _lamda_axis = 1 - _energy_x_axis
# _absorb_axis = 1 - _trans_y_axis
...
if _plot_each_contribution == 1:
    if _trans_y_axis == 1:
        plt.plot(_x_axis, trans_dict['235-U'], label='235-U')
        plt.plot(_x_axis, trans_dict['238-U'], label='238-U')
    else:
        plt.plot(_x_axis, absorb_dict['235-U'], label='235-U')
        plt.plot(_x_axis, absorb_dict['238-U'], label='238-U')
