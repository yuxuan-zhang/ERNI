...
_input_ele_str = 'Co'  # input('Please input the chemicals? ')
...
ideal_y_index = pku.indexes(y_attenu_tot, thres=0.5, min_dist=50)#, thres=0.1, min_dist=50)
...
plt.plot(x_energy[ideal_y_index], y_attenu_tot[ideal_y_index], 'b+', label='peak_ideal')


# Experiment
source_to_detector_cm = 1610.9  # cm
delay_ms = 4.5 - 16.61295379  # ms
