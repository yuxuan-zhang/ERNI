...
plot_function._get_plot(thick_mm, element, density_sample, ele_at_ratio, _database, energy_max, energy_min, energy_sub, _type_x_axis, _type_y_axis, _plot_each_contribution, _plot_mixed)
