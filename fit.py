...
# Ideal
elements, isotope_dict, density_gcm3_dict, molar_mass_dict, x_energy, sigma_iso_ele_eleisodict, sigma_iso_ele_sum_eledict = _fit_functions.get_sigma_term(_input_ele_str,
                                                                                                energy_max,
                                                                                                energy_min,
                                                                                                energy_sub)
